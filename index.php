 ...
 * Plugin URI: https://www.oxilabdemos.com/shortcode-addons/
 * Version: 3.2.5
 * Author: biplob018
...
define('SA_ADDONS_PLUGIN_VERSION', '3.2.5');
...
register_activation_hook(__FILE__, function () {
    $installer = \SHORTCODE_ADDONS\Helper\Installation::instance();
    $installer->plugin_activation_hook();
});
...
add_action('upgrader_process_complete', function () {
    $migration = \SHORTCODE_ADDONS\Helper\Installation::instance();
...
register_deactivation_hook(__FILE__, function () {
    $Installation = \SHORTCODE_ADDONS\Helper\Installation::instance();
